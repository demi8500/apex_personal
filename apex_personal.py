...
if menu == "Dashboard":
    ...
    st.success(f"Bei ca. 12% Rendite erreichst du dein Ziel in ca. **{round((ziel / (monatlich*12*1.1)),1)} Jahren**")
    ...
    st.subheader("🚀 Beste Strategien 2026")
    st.info("DCA + monatliches Rebalancing + Yield-Optimierung ist eine der stärksten Kombinationen.")
...
st.caption("APEX Personal v5.0 - Maximale Version | Nur für dich")
